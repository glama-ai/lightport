...
export const finishReasonMap = new Map<PROVIDER_FINISH_REASON, FINISH_REASON>([
  ...
  [VERTEX_GEMINI_GENERATE_CONTENT_FINISH_REASON.MALFORMED_FUNCTION_CALL, FINISH_REASON.stop],
  [VERTEX_GEMINI_GENERATE_CONTENT_FINISH_REASON.IMAGE_SAFETY, FINISH_REASON.content_filter],
