...
import { EmbedInstancesData, LightportGeminiParams } from './types';
import { transformGeminiThinkingConfig } from './utils';
/**
 * @see https://cloud.google.com/vertex-ai/generative-ai/docs/model-reference/gemini#request_body
 */
export function transformGenerationConfig(params: LightportGeminiParams) {
