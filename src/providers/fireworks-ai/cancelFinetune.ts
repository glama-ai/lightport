...
export const FireworkCancelFinetuneResponseTransform = (response: any, status: number) => {
  if (status !== 200) {
...
export const FireworksCancelFinetuneRequestHandler: RequestHandler<Params> = async ({
  requestBody,
  requestURL,
  providerOptions,
  c,
