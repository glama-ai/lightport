...
export type RequestHandler<T = Params | FormData | ArrayBuffer | ReadableStream> = (Params: {
  c: GatewayContext;
  providerOptions: Options;
  requestURL: string;
  requestHeaders: Record<string, string>;
...
export type RequestTransforms = Partial<
  Record<endpointStrings, (requestBody: any, requestHeaders: Record<string, string>) => any>
>;
