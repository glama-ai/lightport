...
import { EmbedParams, EmbedResponse, EmbedResponseData } from '../../types/embedRequestBody';
...
export const CohereEmbedResponseTransform: (
  ...
  // lightport only supports float embeddings for cohere to confirm to openai signature
