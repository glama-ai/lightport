...
const GoogleApiConfig: ProviderAPIConfig = {
  ...
  getEndpoint: ({ fn, providerOptions, gatewayRequestBodyJSON: gatewayRequestBody }) => {
  ...
  getProxyEndpoint: ({ reqPath, reqQuery, providerOptions, requestHeaders: _requestHeaders }) => {
    const { apiKey } = providerOptions;
